...
1. Các bước xảy ra khi gõ https://shopee.vn vào trình duyệt và nhấn Enter
    ...
    - Bước 5: Reponse chạy ngược lại: cáp quang -> VNOT -> router -> laptop
...
Câu A2:
    - Trang web sử dụng quá nhiều thẻ '<div>' không mang ý nghĩa khiến công cụ tìm kiếm như Google khó hiểu cấu trúc trang (header, menu, nội dung chính, footer,..) nên bị đánh giá SEO 
    - 4 lỗi semantic:
